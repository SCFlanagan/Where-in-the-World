        ...
        return (
            <div> 
                ...
                <Modal show={this.state.showModal} onHide={this.close} id="instructions">
                    ...
                    <Modal.Header id="instructions-header">
                    ...
                    <Modal.Body>
                        ...
                        <p>In each round, you will be given a street view of a location somewhere in the world. You can click and drag inside the map to look around 360 degrees. On some maps, you also have the ability to move around by clicking once in a certain direction.</p>
                        ...
                        <Button bsStyle="info" bsSize="large" onClick={this.close}>Close</Button>
                    </Modal.Body>
